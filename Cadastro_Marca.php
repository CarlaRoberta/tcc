                        ...
                        <tbody>
                            ...
                            while ($dados = mysqli_fetch_assoc($result)) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $nome; ?></td>
                                    <td class="text-right"><a href="form_alterar/form_alterar_marca.php?id= <?php echo $id_marca; ?>" class=" btn btn-sm btn-warning"><span class="glyphicon glyphicon-pencil"></span></a>
